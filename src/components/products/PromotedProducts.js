...
const PromotedProducts = () => {
  return <div className="promotedProducts">
      <div className='topPromoted'>
          <div className="imgPromoted"><img className='promotedImg'src={promotedProduct1} alt="Promoted img"></img></div>
          <div className="imgPromoted"><img className='promotedImg'src={promotedProduct2} alt="Promoted img"></img></div>
          <div className="imgPromoted"><img className='promotedImg'src={promotedProduct3} alt="Promoted img"></img></div>
      </div>
      <div className='bottomPromoted'>
          <div className="imgPromoted"><img className='promotedImg'src={promotedProduct4} alt="Promoted img"></img></div>
          <div className="imgPromoted"><img className='promotedImg'src={promotedProduct5} alt="Promoted img"></img></div>
          <div className="imgPromoted"><img className='promotedImg'src={promotedProduct6} alt="Promoted img"></img></div>
      </div>
  </div>;
};
