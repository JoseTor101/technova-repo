...
const url="https://localhost/Technova/tv_category.php";

class CrudTry extends Component {
state={
  data:[],
  modalInsertar: false,
  modalEliminar: false,
    ...
    <table className="table ">
      ...
      <tbody>
        {this.state.data.map(empresa=>{
          ...
          <td>
                <button className="btn btn-primary" onClick={()=>{this.seleccionarEmpresa(empresa); this.modalInsertar()}}></button>
                {"   "}
                <button className="btn btn-danger" onClick={()=>{this.seleccionarEmpresa(empresa); this.setState({modalEliminar: true})}}></button>
                </td>
          </tr>
          )
        })}
