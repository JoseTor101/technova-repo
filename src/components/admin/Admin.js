      ...
      <Fragment>
         ...
         <p>Total de productos en base de datos: #</p>
          <ul> 
              ...
              <li><button>Agregar</button>
              <ol>
                  <li>Ingrese el tipo de producto</li>
                  <li>De acuerdo al tipo de producto aparece una tabla para llenar on los detalles del tipo de producto seleccionado, por ejemplo si es televisor que aparezca nombre, marca, smartTV, etc.</li>
                  <li>Todos los campos deben estar diligenciados</li>
                  <li>Botón para subir el producto</li>
              </ol>
              </li>
              <li><button>Modificar</button>
              <ol>
                  <li>Se filtra primero hasta encontrar el producto</li>
                  <li>Los detalles actuales del producto aparecen en una tabla. Luego aparece un Menu para cambiar los detalles actuales</li>
              ...
              <p><b>Consultar acerca de cómo hacer herramienta de consulta, CRUD, etc. Con PHP y SQL</b></p>
          </ul>
      </Fragment>
    );
  };
